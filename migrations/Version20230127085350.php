 ...
 */
final class Version20230127085350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categoria (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(30) NOT NULL, ape1 VARCHAR(40) NOT NULL, ape2 VARCHAR(40) DEFAULT NULL, contraseña VARCHAR(10) NOT NULL, correo_electronico VARCHAR(100) NOT NULL, nickname VARCHAR(15) NOT NULL, rol VARCHAR(20) NOT NULL, num_telegram INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
